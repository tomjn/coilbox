...
function SelectContent({
  ...
  /**
   * Render the list in place rather than portalling it to `document.body`.
   *
   * Set this inside a dialog or drawer. A portalled list is not a DOM
   * descendant of the dialog, so a click on it reads as a click outside and
   * dismisses the dialog, taking the whole drawer and everything the user
   * typed with it. In place, the list cannot be mistaken for outside.
   */
  portalled?: boolean;
}) {
  const content = (
