...
/// Where catalog art is cached, re-exported because the asset protocol
/// (`src-tauri/src/asset_protocol.rs`) serves this folder as its
...
pub fn init<R: Runtime>() -> TauriPlugin<R> {
    Builder::new("coilbox-content")
        .invoke_handler(tauri::generate_handler![
            ...
            content_open_path,
            demo::content_list_replays,
            demo::content_demo_info,
            demo::content_replay_trailer,
            ...
            settings_backup::content_config_profiles,
            settings_backup::content_config_backup,
            settings_backup::content_config_restore,
            settings_backup::content_config_delete_profile,
            keybinds::content_keybinds_read,
            keybinds::content_keybinds_write,
            keybinds::content_keymaps,
            keybinds::content_keymap_save,
            keybinds::content_keymap_delete,
